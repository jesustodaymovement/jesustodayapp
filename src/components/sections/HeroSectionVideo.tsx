  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-anthracite pt-20">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-anthracite/50" />
      ...
      <div className="relative z-10 container mx-auto px-6 py-24 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex justify-center gap-4 pt-4 animate-fade-up delay-300">
            <a href="https://apps.apple.com/nl/app/jesus-today/id1623308816" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-warm-white/10 border border-warm-white/20 backdrop-blur-sm hover:bg-warm-white/20 transition-colors">
            ...
            <a href="https://play.google.com/store/apps/details?id=io.mxapps.jesustoday" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-warm-white/10 border border-warm-white/20 backdrop-blur-sm hover:bg-warm-white/20 transition-colors">
              <svg viewBox="0 0 24 24" className="w-6 h-6 text-warm-white" fill="currentColor">
