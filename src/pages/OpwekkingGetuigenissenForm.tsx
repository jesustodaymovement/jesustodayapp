            ...
            <div className="rounded-2xl border border-anthracite/10 bg-white p-6 md:p-8 shadow-sm">
              <SubmissionForm
                ...
                fields={[
                  ...
                  { name: 'plaats', label: t('If under age: Parents Email'), type: 'email', placeholder: 'jij@voorbeeld.nl' },
                  ...
                  { name: 'verhaal_website', label: t('Upload on JT Website'), type: 'yesno', required: true },
                  ...
                  { name: 'instagram', label: t('Instagram'), placeholder: '@jouwnaam' },
                  {
                    name: 'message',
