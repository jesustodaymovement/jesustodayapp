        ...
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-anthracite mb-16">
              Jouw <span className="text-gold">transformatie</span>
            </h2>
          </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <div className="p-8 rounded-2xl bg-anthracite text-warm-white h-full border border-gold/20">
                ...
                <p className="text-warm-white/90 leading-relaxed">
                  Een <span className="text-gold font-semibold">vrijmoedige getuige</span> die deelt vanuit vertrouwen in wie hij of zij is in Jezus — en ziet dat God het gebruikt om levens te veranderen.
                </p>
              </div>
            </ScrollReveal>
          </div>
