      ...
      blocks: [
        ...
        { type: 'p', text: 'Afhankelijk van de dienst die je gebruikt, kunnen wij onder andere samenwerken met de volgende partijen:' },
        {
          ...
          items: [
            ...
            { term: 'Mailgun', sep: ' – ', desc: 'voor het versturen van e-mails vanuit onze formulieren, zoals bevestigingen en notificaties.' },
      ...
      blocks: [
        ...
        { type: 'p', text: 'Depending on the service you use, we may work with the following parties, among others:' },
        {
          ...
          items: [
            ...
            { term: 'Mailgun', sep: ' – ', desc: 'for sending emails from our forms, such as confirmations and notifications.' },
