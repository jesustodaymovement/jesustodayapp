        ...
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/20 mb-8">
              ...
              <span className="text-gold text-sm font-medium">Begin vandaag</span>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={200}>
            <p className="text-lg md:text-xl text-warm-white/80 mb-8 leading-relaxed">
          ...
          <ScrollReveal delay={500}>
            <div className="flex justify-center gap-4">
              <a href="#" className="group">
                <div className="flex items-center gap-3 px-5 py-3 rounded-xl bg-warm-white/10 border border-warm-white/20 hover:bg-warm-white/20 transition-all duration-300">
                  <svg viewBox="0 0 24 24" className="w-8 h-8 text-warm-white" fill="currentColor">
                    <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                  </svg>
                  <div className="text-left">
                    <span className="text-warm-white/60 text-xs block">Download on the</span>
                    <span className="text-warm-white font-semibold">App Store</span>
                  </div>
                </div>
              </a>
              <a href="#" className="group">
                <div className="flex items-center gap-3 px-5 py-3 rounded-xl bg-warm-white/10 border border-warm-white/20 hover:bg-warm-white/20 transition-all duration-300">
                  ...
                  <div className="text-left">
                    <span className="text-warm-white/60 text-xs block">Get it on</span>
                    <span className="text-warm-white font-semibold">Google Play</span>
                  </div>
                </div>
              </a>
            </div>
