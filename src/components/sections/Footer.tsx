          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="#" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-warm-white/10 border border-warm-white/20 hover:bg-warm-white/20 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#" className="text-warm-white/60 hover:text-gold transition-colors">Doneren</a>
                </li>
                <li>
